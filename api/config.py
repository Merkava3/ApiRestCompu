...
<<<<<<< HEAD
    SQLALCHEMY_DATABASE_URI = 'postgresql://tecnoexpress_vunw_user:YzqRbUB1TN3NvAu2rFKRtOHNrRrdafw0@dpg-d11qnfemcj7s73el20mg-a.oregon-postgres.render.com/tecnoexpress_vunw'
=======
    SQLALCHEMY_DATABASE_URI = 'postgresql://tecnoexpress_owner:npg_zNdIya8tj6TG@ep-round-paper-acxjrr4q-pooler.sa-east-1.aws.neon.tech/tecnoexpress?sslmode=require'
>>>>>>> 8f0b6e2 (chore(config) change link conection neo postgresql)
